  ...
  return (
    <Wrapper>
      ...
      <Paragraph title="Que países, além dos EUA, aceitam o Dólar hoje?" >
        <Text>Pelo efeito da Dolarização, segue a lista de países que aceita pagamentos em dólar americano nas suas transações internas:</Text>
        <List>
          <li>Equador</li>
          <li>Panamá</li>
          <li>El-Salvador</li>
        ...
        <Text>Além desses países, temos aqueles que possuem outros tipos de dólar, como: East Caribbean Dollar, Australian Dollar, Singapore Dollar, Canadian Dollar, Cayman Island Dollar e Hong Kong Dollar.</Text>
      </Paragraph>
      <Paragraph title="O que influencia a cotação do Dólar hoje?" >
        <Text>Assim como as demais moedas, a oferta e procura é um dos fatores da variação cambial. Além deles podemos citar:</Text>
        <List>
      ...
      <Paragraph title="O que é o câmbio flutuante?" >
        <Text>O câmbio flutuante é quando um país decide não impor uma política cambial e deixa com que o próprio mercado se regule livremente. Sendo assim, não há o controle por parte do governo da compra e venda das moedas o que favorece a lei da oferta e da procura.</Text>
      </Paragraph>
      <Paragraph title="Qual a hora certa de comprar Dólar?" >
        <Text>Existem algumas dicas para que você compre dólares de maneira mais satisfatória e rentável, dentre elas estão:</Text>
        <List>
      ...
      <Image src="https://cdn.pixabay.com/photo/2016/04/30/00/28/dollar-1362243_960_720.jpg" alt="dolar"/>
      <List>
        <Text>Dicas para você descobrir se a nota é falsa ou não:</Text>
